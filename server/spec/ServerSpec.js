...
describe('Node Server Request Listener Function', function() {
  ...
  it('Should filter messages by query parameters', function() {
    var stubMsg = {
      username: 'Jono',
      message: 'Do my bidding!',
      room: 'library'
    ...
    expect(res._responseCode).to.equal(201);
      ...
      // Now if we request the log for that room the message we posted should be there:
    req = new stubs.request('/classes/messages?room=dungeon', 'GET');
    res = new stubs.response();
  ...
  it('Should POST messages with query parameters', function() {
    var stubMsg = {
      username: 'Jono',
      message: 'Do my bidding!'
    };
    var req = new stubs.request('/classes/messages?room=library', 'POST', stubMsg);
    var res = new stubs.response();
